...
public class UserScanner {
    ...
    public String enterName() {
        ...
        while (true) {
            try {
                ...
                String name_without_space = name.replaceAll("\\s+", "");
                if (!name.equals("") && (!name_without_space.equals(""))) {
                    return name;
                }
            } catch (NoSuchElementException exception) {
                System.out.println("The input stream is over. The program is stopped");
    ...
    public Coordinates enterCoordinates() {
        ...
        while (true) {
            ...
            try {
                x = Integer.parseInt(userScanner.nextLine().trim().split(" ", 2)[0]);
                if (x > -340) {
                    break;
                }
                else {
        ...
        while (true) {
            ...
            try {
                y = Double.parseDouble(userScanner.nextLine().trim().split(" ", 2)[0]);
                break;
            } catch (NumberFormatException nfe) {
                System.out.println("input is incorrect");
            }  catch (NoSuchElementException exception) {
    ...
    public Float enterAnnualTurnover() {
        ...
        while (true) {
            try {
                ...
                annualTurnover = Float.parseFloat(userScanner.nextLine().trim().split(" ", 2)[0]);
                if (annualTurnover > 0) {
                    break;
                }
    ...
    public Integer enterEmployeesCount() {
        ...
        while (true) {
            try {
                ...
                employeesCount = Integer.parseInt(stringEmployeesCount.trim().split(" ", 2)[0]);
                if (employeesCount > 0) {
                    break;
                }
            } catch (NumberFormatException cfe) {
    ...
    public OrganizationType enterOrganizationType() {
        ...
        while (true) {
            try {
                type = userScanner.nextLine().trim().split(" ", 2)[0];
            } catch (NoSuchElementException exception) {
                System.out.println("The input stream is over. The program is stopped");
                System.exit(1);
            }
    ...
    public Address enterPostalAddress() {
        ...
        while (true) {
            ...
            try {
                String stringCheck = userScanner.nextLine().trim().split(" ", 2)[0];
        ...
        while (true) {
            try {
                ...
                street = userScanner.nextLine().trim().split(" ", 2)[0];
                if (!street.equals("")) {
                    break;
                }
            } catch (NoSuchElementException exception) {
        ...
        while (true) {
            ...
            try {
                zipcode = userScanner.nextLine().trim().split(" ", 2)[0];
                if (zipcode.length() >= 3) {
                    break;
                } else {
                    System.out.println("input is incorrect");
     ...
     */
    public FlyOrganization enterOrganization() {
        ...
        return new FlyOrganization(name, coordinates, annualTurnover, fullName, employeesCount, type, postalAddress);
    }
}
